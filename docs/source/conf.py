...
project = 'Kyte'
copyright = '2020, Missing Bit Studios'
...
breathe_projects = {
   'kyte': abspath('../build/doxygen/xml/')
}
...
latex_documents = [
    (master_doc, 'Kyte.tex', 'Kyte Documentation',
...
man_pages = [
    (master_doc, 'kyte', 'Kyte Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Kyte', 'Kyte Documentation',
     author, 'Kyte', 'Kyte is an open source game engine written in C++.',
     'Miscellaneous'),
]
