/* Generated by re2c 1.0.1 on Wed Aug 14 15:22:20 2019 */
...
#line 1393 "parser.cpp.re" // lalr1.cc:408
...
#line 1401 "parser.cpp.re" // lalr1.cc:412
...
#line 1416 "parser.cpp.re" // lalr1.cc:413
...
namespace yy {
#line 1502 "parser.cpp.re" // lalr1.cc:479
...
#line 1925 "parser.cpp.re" // lalr1.cc:859
    break;

  case 4:
#line 48 "parser.yy" // lalr1.cc:859
    { yylhs.value.as< Function > () = Function(yystack_[6].value.as< float > ()); }
#line 1931 "parser.cpp.re" // lalr1.cc:859
    break;


#line 1935 "parser.cpp.re" // lalr1.cc:859
            default:
              break;
            }
        }
...
#undef YYCASE_
  ...
  const signed char conj_parser::yypact_ninf_ = -7;
  ...
  {
  "END", "error", "$undefined", "FLOAT", "IDENTIFIER", "TYPE", "\"->\"",
  "'('", "')'", "'{'", "'}'", "$accept", "functions", "function", YY_NULLPTR
  };
...
#line 2303 "parser.cpp.re" // lalr1.cc:1167
#line 50 "parser.yy" // lalr1.cc:1168
...
yy15:
#line 2328 "parser.cpp.re"
	{ return s(conj_parser::make_FLOAT, std::stof(std::string(anchor,ctx.cursor))); }
...
yy30:
#line 2322 "parser.cpp.re"
	{ return s(conj_parser::make_TYPE, stot(std::string(anchor,ctx.cursor))); }
#line 2649 "parser.cpp"
}
#line 2339 "parser.cpp.re"
 /* End lexer */
}
